<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kaazing_2015102201.aspx.cs" Inherits="KaazingTestWebApplication.Kaazing_2015102201" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //https://host.leonlee.com/KaazingWebService/KaazingService.asmx/SendMessage
        var sendAjaxMessage = function () {
            $.ajax({
                url: "https://host.leonlee.com/KaazingWebService/KaazingService.asmx/SendMessage",
                data: "{ 'message': " + JSON.stringify(document.getElementById("message").value) +
