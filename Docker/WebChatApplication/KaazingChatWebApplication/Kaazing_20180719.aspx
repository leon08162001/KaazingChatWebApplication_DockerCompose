<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kaazing_20180719.aspx.cs" Inherits="KaazingTestWebApplication.Kaazing" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //
        var MY_WEBSOCKET_URL = "wss://TWM004.tw-moneysq.local:9001/jms";
        var LISTEN_TOPIC = "DEMO.NUOMS.JefferiesReport.Req";
        ...
        var openMessageClient = function () {
            try
            {
                ...
                messageClient.WebUiObject
                //var messageClient = new MessageClient(MY_WEBSOCKET_URL,document.getElementById("userID").value,document.getElementById("pwd").value,LISTEN_TOPIC,document.getElementById("divMsg1"));
                ...
                messageClient.listenName = LISTEN_TOPIC;
                messageClient.WebUiObject = document.getElementById("divMsg1");
            ...
            {
                document.getElementById("divMsg1").innerHTML += e + "</br>";
            }
        };
        ...
        //../KaazingWebService/KaazingService.asmx/SendMessageToServer
        //https://TWM004.tw-moneysq.local/KaazingWebService/KaazingService.asmx/SendMessageToServer
        var ajaxProgress = null;
        var sendAjaxMessage = function () {
            document.getElementById("sendMessage").disabled = true;
            ajaxProgress = $.ajax({
                url: "https://TWM004.tw-moneysq.local/KaazingWebService/KaazingService.asmx/SendMessageToServer",
                data: "{ 'jsonMessage': " + JSON.stringify(document.getElementById("message").value) +
