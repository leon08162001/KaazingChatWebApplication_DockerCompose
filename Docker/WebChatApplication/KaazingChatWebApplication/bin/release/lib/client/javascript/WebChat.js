...
var messageTalkServiceUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/SendTalkMessageToServer";
var chkWebSocketLoadBalancerUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/GetWebSocketLoadBalancerUrl";
...
var messageAjaxServiceUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/SendAjaxMessageToServer";

//因android 瀏覽器執行下列上傳檔案asmx會出現error,故改用呼叫ashx方式進行(暫查不出原因,因PC上瀏覽器執行上傳檔案asmx沒有問題)
//var messageUploadFileUrl = "https://leonnote.asuscomm.com:2443/KaazingChatWebService/ChatService1.asmx/UploadFile";

//WebSocketUploadFile
//var messageUploadFileUrl = "https://leonnote.asuscomm.com:2443/KaazingChatWebService/UploadFile.ashx";
//MQUploadFile
//var messageUploadFileUrl = "https://leonnote.asuscomm.com:2443/KaazingChatWebService/UploadFile1.ashx";
//EMSUploadFile
//var messageUploadFileUrl = "https://leonnote.asuscomm.com/KaazingChatWebService/UploadFile2.ashx";

//WebSocketUploadFile
//var messageUploadFileUrl = "https://leonnote.asuscomm.com:2443/KaazingChatWebApi/api/WebChat/UploadFile";
//MQUploadFile
//var messageUploadFileUrl = "https://leonnote.asuscomm.com:2443/KaazingChatWebApi/api/WebChat/UploadFile1";
//EMSUploadFile
//var messageUploadFileUrl = "https://leonnote.asuscomm.com:2443/KaazingChatWebApi/api/WebChat/UploadFile2";
...
var messageUploadFileUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/UploadFile";
//MQUploadFile
...
var messageUploadStreamUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/UploadStream";
var messageUploadStreamToSaveUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/UploadStreamToSave";
...
var chatUpdate = function (chat, isExit) {
    ...
    var chatUpdateServiceUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/ChatUpdate";
    if (!isExit) {
        ...
        if (navigator.sendBeacon) {
            ...
            chatUpdateServiceUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/ChatUpdateWhenExit";
...
var getChatToday = function () {
    ...
    var serviceUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/GetChatToday";
    var chat = {};
...
var getChatHistory = function () {
    ...
    var serviceUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/GetChatHistory";
...
var GetAllTalkFriends = function () {
    ...
    var serviceUrl = "https://leonnote.asuscomm.com:8081/KaazingChatWebApi/api/WebChat/GetAllTalkFriends";
    var chat = {};
...
$(document).ready(function () {
    ...
    $('#btnUploadFile').on('click', function () {
            ...
            $.each(senders, function (i) {
                for (j = 0; j < Number($("#times").val()); j++) {
                    for (var k = 0; k < files.length; k++) {
                        messageClient.sendFileByChunk(files[k].name, files[k], senders[i]);
                        //messageClient.sendFile(files[k].name, files[k], senders[i]);
                    }
                }
            });
        }
        //一人傳檔
            ...
            for (j = 0; j < Number($("#times").val()); j++) {
                for (var k = 0; k < files.length; k++) {
                    messageClient.sendFileByChunk(files[k].name, files[k], messageClient.sendName);
                    //messageClient.sendFile(files[k].name, files[k], messageClient.sendName);
                }
            }
        }
